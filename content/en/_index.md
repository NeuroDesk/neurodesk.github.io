...
<section class="row td-box -bg-dark justify-content-left h-auto col-big-desktop">
	...
	<div class="col-md-8 col-lg-first order-xs-2 order-sm-2 order-md-2 my-auto">
		...
		<div class="mx-auto mt-5">
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/support/faq/#what-is-neurodesk">
				What is Neurodesk ?</a>
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/getting-started/neurodesktop/play">
				<i class="fa fa-play"></i> Play </a>
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/getting-started/neurodesktop/nectar">
				<i class="fa fa-display"></i> Nectar </a>
			<a class="btn btn-lg btn-light mb-4" target="_blank"
				href="docs/getting-started/neurocontainers/googlecolab/">
				<i class="fab fa-google"></i> Google Colab </a>
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/getting-started/neurodesktop/windows">
				<i class="fab fa-windows"></i> Windows </a>
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/getting-started/neurodesktop/mac">
				<i class="fab fa-apple"></i> MacOS </a>
			<a class="btn btn-lg btn-light mb-4" target="_blank" href="docs/getting-started/neurodesktop/linux">
