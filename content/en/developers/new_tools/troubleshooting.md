...
many contributors because upstream/neurocontainer will have new commits while you're
...
Working from multiple computers with neurocontainer and Git is fine, but you'll need to
...
When you first start working on a new computer, you'll [clone the neurocontainer
repository][clone-to-your-machine] and [connect it to neurocontainer
...
[clone-to-your-machine]: ../cloning#step-1b-clone-to-your-machine
[connect-upstream]: ../cloning#step-1c-connect-your-fork-to-neurocontainers-upstream
