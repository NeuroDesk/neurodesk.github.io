...
### 2. Install Docker
Install Docker on the cloud instance from here: https://docs.docker.com/get-docker/. Additional information available here: https://neurodesk.org/docs/neurodesktop/getting-started/linux/#installing-docker 
...
```
If the computer runs Linux, check specific instructions at https://neurodesk.org/docs/neurodesktop/getting-started/linux/, Option 2, Step 3.
